...
export default function FeedPostsSkeleton({ count = 3, withSpinner = true }: Props) {
  const content = (
    <Stack spacing={1.25} aria-label={withSpinner ? undefined : 'Loading posts'}>
  ...
  return (
    <SkeletonLoadingShell aria-label="Loading posts">
      {content}
